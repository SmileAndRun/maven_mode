...
-- ----------------------------
-- Table structure for qrtz_self_data
-- ----------------------------
DROP TABLE IF EXISTS `qrtz_self_data`;
CREATE TABLE `qrtz_self_data`  (
  `DATAID` int(11) NOT NULL DEFAULT 0 AUTO_INCREMENT,
  `JOBNAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `qrtz_self_defined`;
CREATE TABLE `qrtz_self_defined`  (
  `JOB_NAME` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `t_log`  (
  ...
  `logMessage` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
